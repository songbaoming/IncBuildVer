...
#define MINOR_VER_NUM					1 // 次版本号
#define REVISION_VER_NUM				1 // 修正版本号
...
#define VERSION_STR TOSTR(MAJOR_VER_NUM) "." TOSTR(MINOR_VER_NUM) "." TOSTR(REVISION_VER_NUM) "." TOSTR(BUILD_VER_NUM)
